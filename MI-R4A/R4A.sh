...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Zyx-OpenWrt'' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/可爱动漫主题/改自ifit/g' package/lean/luci-theme-argon_armygreen/luasrc/view/themes/argon_armygreen/footer.htm
